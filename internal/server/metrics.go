...
func renderPrometheusMetrics(summary *tracker.UsageSummary, records []tracker.UsageRecord) string {
	...
	builder.WriteString(fmt.Sprintf("lcg_usage_records_total %d\n", summary.RecordCount))
	...
	builder.WriteString(fmt.Sprintf("lcg_cost_usd_total %.6f\n", summary.TotalCostUSD))
	...
	builder.WriteString(fmt.Sprintf("lcg_input_tokens_total %d\n", summary.TotalInputTokens))
	...
	builder.WriteString(fmt.Sprintf("lcg_output_tokens_total %d\n", summary.TotalOutputTokens))
